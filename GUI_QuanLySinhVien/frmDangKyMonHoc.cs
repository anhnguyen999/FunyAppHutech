...
namespace GUI_QuanLySinhVien
{
    public partial class frmDangKyMonHoc : Form
    {
        ...
        private void ControlConfig()
        {
            ...
            lstDanhSachMonHocChuaChon.DisplayMember = "Ten Mon Hoc";
            lstDanhSachMonHocDaChon.DisplayMember = "Ten Mon Hoc";
        ...
        private void LoadDahSachDangKy()
        {
        ...
        private void LoadMonHocTheoChuyenNganh(int maChuyenNganh)
        {
            ...
            {
                if (!lstDanhSachMonHocChuaChon.Items.Contains(item))
